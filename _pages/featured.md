...
{% include figure.liquid path="assets/img/featured/the-conversation.png" class="img-fluid z-depth-1 rounded" alt="The Conversation article" max-width="400px" %}
...
{% include figure.liquid path="assets/img/featured/cjps-article.png" class="img-fluid z-depth-1 rounded" alt="Canadian Journal of Political Science article" max-width="400px" %}
